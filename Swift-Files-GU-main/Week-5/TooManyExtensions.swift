...
// Task with extension & computed properties task:
...
let song1 = Song(title: "song-1", artist: "Artist-1", duration: 03.23)
let song2 = Song(title: "song-2", artist: "Artist-2", duration: 07.35)
let song3 = Song(title: "song-3", artist: "Artist-3", duration: 04.56)

let myPlaylist = Playlist(
    name: "Playlist-1",
    numberOfSongs: [song1, song2, song3]
)
print(myPlaylist.playlistDuration)
